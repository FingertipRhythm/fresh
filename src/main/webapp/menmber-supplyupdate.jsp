...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">标准修改</a>
        </div>
         <!-- 会员左侧 -->
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="menuPro-second">
                        ...
                        <a href="javascript:;" class="selected"><i class="fa fa-angle-right"></i>已关闭资源单</a>
                    </div>
                </dd>
         ...
         <div class="member-right">
            <div class="member-main">
                ...
                <div class="member-column">
                    <div class="member-tit"><p>关闭的资源单详情</p></div>
                    <div class="detail-con">
                        ...
                        <dl>
                            <dt>备注：</dt>
                            <dd>
                                <p>备注说明备注说明备注说明备注说明备注说明备注说明备注说明</p>
                            </dd>
                            <dt>上传时间：</dt>
                            <dd>
                                <p>2015-05-25 14:15</p>
                            </dd>
                            <dt>审核时间：</dt>
                            <dd>
                                <p>2015-05-25 14:15</p>
                ...
                <div class="member-column">
                     <div class="controls">
                        <p><span>*</span>公司名称：</p>
                        <div class="basic-name">漯河市嘉沣商贸有限公司</div>
                    </div>
                    <div class="controls">
                        <p><span>*</span>公司名称：</p>
                        <div class="basic-name">漯河市XXX区小XXX路冷链工业园</div>
                    </div>
                    <div class="controls">
                        <p><span>*</span>联系电话：</p>
                    ...
                    <div class="method-table">
                        ...
                        <input type="submit" value="修改" class="btn01 pop-sub">
                    </div>
                </div>
            </div>
         </div>
...
<div class="mask01">
    ...
    <div class="bigPic">
        <div class="tit"><p>提示</p><i class="fa fa-times-circle-o"></i></div>
        <div class="con">
            <h6>资源单已经成功提交，请等待交易员审核</h6>
            <p>交易员将在<span>24小时内</span>审核，请您耐心等待。</p>
            <div class="btns">
                <a href="javascript:;" class="btn02 closed">关闭</a>
            </div>
        </div>
    </div>
</div>
