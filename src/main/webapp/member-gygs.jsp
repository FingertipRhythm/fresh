         ...
         <div class="member-right">
            <div class="member-main">
                <div class="member-column">
                    ...
                    <form action="give/gsadd"   enctype="multipart/form-data"  method="post">
                     <div class="member-con">
                     			
                     			  <div>
			                   <%--   <input type="hidden"  name="userid"  value="${sessionScope.myuser.userid}"> --%>
		                        ...
		                        <div class="controls">
		                            <p><span>*</span>公司名称：</p>
		                            <input type="text" class="input03 w450"  name="cname" >
		                        </div>
		                   ...
		                   <div class="controls">
	                        ...
	                        <div class="controls">
		                            ...
		                            <div class="upload-controls">
		                                  ...
		                                  <input type="file" value="点击上传" class="upload-btn w148" name="pic">
		                            </div>
	                        ...
	                        <div class="controls">
	                            ...
	                            <input type="text" class="input03 w250" name="qyfrname">
	                        </div>
                       		 <div class="member-subtit">授权运营者信息填写</div>
	                        <div class="controls">
	                            <p><span>*</span>运营者姓名：</p>
	                            <input type="text" class="input03 w250" name="rname">
	                        </div>
	                        <div class="controls">
	                            <p><span>*</span>运营者职务：</p>
	                            <input type="text" class="input03 w250" name="post">
	                        </div>
	                        <div class="controls">
	                            <p><span>*</span>运营者联系方式：</p>
	                            <input type="text" class="input03 w250" name="gphone">
	                        </div>
	                        <div class="controls">
