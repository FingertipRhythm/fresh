...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">资源预览</a>
        </div>
         <!-- 会员左侧 -->
         ...
         <div class="member-right">
            <div class="member-tit"><p>资源单详细信息</p></div>
            <div class="detail-con">
                <dl>
                    ...
                    <dt>公司地址：</dt>
                    <dd>
                        <p>漯河市XXX区小XXX路冷链工业园</p>
                    </dd>
                    <dt>联系电话：</dt>
                    <dd>
                        <p>0755-12345786 0755-12345786</p>
                    </dd>
                    <dt>资源单说明：</dt>
                    <dd>
                        <p>资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明资源单说明</p>
                    </dd>
                </dl>
            </div>
            <!-- 搜索表格 -->
            <div class="search-table">
                ...
                <input type="submit" value="修改此资源单，重新发布" class="btn01 w170">
                <!-- page -->
                <div class="list-page">
                    <ul>
