        ...
        <div class="member-left">
            <dl>
                ...
                <dd>
                    ...
                    <div class="menuPro-second">
                       ...
                       <c:if test=""></c:if>
                        <a href="member-sjgy.jsp"><i class="fa fa-angle-right"></i>升级供应商</a>
                        <a href="member-sjcj.jsp"><i class="fa fa-angle-right"></i>升级采购商</a>
         ...
         <div class="member-right">
            ...
            <div class="member-upgrade">
                <img src="images/member-upgrade01.png" alt="">
            </div>
                    ...
                    <div class="member-tit"><p>我想认证成为</p></div>
                     <div class="member-con">
                        <ul class="upgrade-list">
                            ...
                            <!-- 供应商 -->
                                <div class="img">
                                    <img src="images/upgrade-icon01.png" alt="">
                                </div>
                                <div class="con">
                                   ...
                                   <a href="give/pdgs" class="btn01">立即认证</a>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="img">
                                    <img src="images/upgrade-icon02.png" alt="">
                                </div>
                                <div class="con">
                                   <p>认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。</p>
                                   <a href="pur/pdgs" class="btn01">立即认证</a>
                                </div>
                            </li>
                            <li>
                                <div class="img">
                                    <img src="images/upgrade-icon03.png" alt="">
                                </div>
                                <div class="con">
                                   <p>认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。</p>
                            ...
                            <li>
                                <div class="img">
                                    <img src="images/upgrade-icon04.png" alt="">
                                </div>
                                <div class="con">
                                   <p>认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单，商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。商品信息发布更新将不再繁琐，认证成为供应商之后可以在线发布自己的资源单。</p>
                                   <a href="javascript:;" class="btn01">立即认证</a>
