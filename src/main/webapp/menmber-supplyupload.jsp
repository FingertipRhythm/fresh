        ...
        <div class="bread-crumbs">
         ...
         <div class="member-left">
            <dl>
                ...
                <dt>供应商管理</dt>
                <dd>
                    <a href="menmber-mysupply.jsp" class="menuPro-first selected"><i class="fa fa-plus-square"></i>升我的资源单</a>
                    <div class="menuPro-second">
                        <a href="menmber-supplyupload.jsp" class="selected"><i class="fa fa-angle-right"></i>上传资源单</a>
                        <a href="member-supplyPreviewing.jsp"><i class="fa fa-angle-right"></i>资源预览</a>
                        <a href="menmber-supplyupdate.jsp"><i class="fa fa-angle-right"></i>修改价格发布</a>
                        <a href="javascript:;"><i class="fa fa-angle-right"></i>待审核资源单</a>
                        <a href="javascript:;"><i class="fa fa-angle-right"></i>已关闭资源单</a>
                    </div>
                </dd>
                <dd><a href="menmber-supplybidding.jsp" class="menuPro-first">我参与的竞标</a></dd>
                <dd><a href="menmber-supplyorder.jsp" class="menuPro-first">我收到的订单</a></dd>
                <dt>采购管理</dt>
             ...
             <div class="lib-tab5">
                ...
                <div class="lib-content">
                    ...
                    <div class="child-content" style="display: none;">
                        <!-- 方法三 -->
                        <div class="method">
                        <form action="sup/addResource" method="post">
                            <dl class="method-center">
                                ...
                                <dd>
                                    <div class="method-table">
                                        ...
                                        <table >
                                            ...
                                            <tbody id='tab'>
                                                <tr >
                                                    ...
                                                    <td>
                                                       <select class="w80" name="classid">
                                                            <option value="0" selected>请选择分类</option>
                                                            <option value="1">冷藏肉类</option>
                                                            <option value="2">冷冻海鲜</option>
                                                            <option value="3">冷藏果蔬</option>
                                                        </select>
                                                    </td>
                                                    <td><input type="text" class="input05" name="productname"></td>
                                                    <td><input type="text" class="input05" name="originplace"></td>
                                                    <td><input type="text" class="input05" name="Specifications"></td>
                                                    <td><input type="text" class="input05" name="grade"></td>
                                                    <td><input type="text" class="input05" name="inventory"></td>
                                                    <td><input type="text" class="input05" name="price"></td>
                                                    <td>
                                                       <select class="w80" >
                                                            <option value="1">RMB</option>
                                                        </select>
                                                    </td>
                                                    <td><input type="text" class="input05" name="storehouse"></td>
                                                    <td>
                                                       <select class="w80" name="sf">
                                        ...
                                        <span class="btn09 add" id="addtab">增加</span>
                                    ...
                                    <div class="controls">
                                        <p>资源单说明：</p>
                                        <textarea class="textarea01 w450" name="resourcelist"></textarea>
                                    </div>
                                </dd>
                                <dd>
                                    <input type="submit" value="发布资源" class="btn01 w155">
...
$("#tab").append("<tr><td><select class='w80' name='classid'><option value='0' selected>请选择分类</option><option value='1'>冷藏肉类</option><option value='2'>冷冻海鲜</option><option value='3'>冷藏果蔬</option></select></td><td><input type='text' class='input05' name='productname'></td><td><input type='text' class='input05' name='originplace'></td><td><input type='text' class='input05' name='Specifications'></td><td><input type='text' class='input05' name='grade'></td><td><input type='text' class='input05' name='inventory'></td><td><input type='text' class='input05' name='price'></td><td><select class='w80' ><option value='1'>RMB</option></select></td><td><input type='text' class='input05' name='storehouse'></td><td><select class='w80' name='sf'><option value='' selected>请选择</option><option value='期货'>期货</option><option value='现货'>现货</option></select></td><td><input type='text' class='input05'></td><td><span class='btn04 w65 del' onclick='deltab(this)'>删除</span></td>");
})
function deltab(sp){
	var tr = sp.parentNode.parentNode;
	
	$("#tab>tr").eq(tr.rowIndex-1).remove();
}
</script>