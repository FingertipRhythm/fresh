	...
	<nav>
		<div class="container">
			<dl>
				...
				<dd>
					<a class="selected" href="javascript:;">采购</a>
				</dd>
				<dd>
		...
		<div class="container">
			...
			<div class="bread-crumbs">
				<a href="javascript:;">首页</a> <span><i
					class="fa fa-angle-double-right"></i></span> <a href="javascript:;">采购</a>
				<span><i class="fa fa-angle-double-right"></i></span> <a
					href="javascript:;" class="selected">发布采购单</a>
			</div>
			<!-- 采购-发布采购单 -->
			<div id="caigou">
				...
				<form action="pc/add" method="post">
					<div class="proof">
						<div class="member-right">
							<div class="member-column">
								<div class="controls">
									<p>采购单名称：</p>
									<input type="text" class="input03 w320"  name="purchase_title" id="purchase_title">
								</div>
								<div class="controls">
									<p>采购物品：</p>
									<input type="text" class="input03 w320" name="purchase_name" id="purchase_name">
								</div>
								<div class="controls">
									<p>产地要求：</p>
									<input type="text" class="input03 w320" name="producing_area" id="producing_area">
								</div>
								<div class="controls">
									<p>规格型号：</p>
									<input type="text" class="input03 w320" name="purchase_type" id="purchase_type">
								</div>
								<div class="controls">
									<p>级别要求：</p>
									<input type="text" class="input03 w320" name="purchase_level" id="purchase_level">
								</div>
								<div class="controls">
									<p>数量要求：</p>
									<input type="text" class="input03 w320" name="purchase_number" id="purchase_number">
								</div>
								<div class="controls">
									<p>仓库要求：</p>
									<input type="text" class="input03 w320" name="storehouse" id="storehouse">
								</div>
								<div class="controls">
									<p>期/现货：</p>
									<input type="text" class="input03 w320" name="state" id="state">
									<!--  <select class="w100">
								...
								<div class="controls">
                                    ...
                                    <input type="text" class="input03 w320" name="price_require" id="price_require">
                                  <!--   <input type="text" class="input03 w125"> --> <i>元/千克</i>
								</div>
								<div class="controls">
									<p>采购说明：</p>
									<div class="method-edit">
										<!-- <img src="images/member-edit02.jpg" alt=""> -->
										<textarea rows="20" cols="70"  name="purchase_description" id="purchase_description"></textarea>
									</div>
									
								</div>
								<div class="controls">
									<p>付款方式：</p>
									<input type="text" class="input03 w320"  name="payment_method" id="payment_method"> <i>如预付款、货到付款、30%定金70%交货时付等</i>
								</div>
								<div class="controls">
									<p>发票类型：</p>
									<div class="controls-radio">
										<input type="radio" name="invoice_type" value="1" class="radio" > <i>增值税发票</i>
									</div>
									<div class="controls-radio">
										<input type="radio" name="invoice_type" value="2" class="radio"> <i>普通发票</i>
									</div>
									<div class="controls-radio">
										<input type="radio" name="invoice_type" value="3" class="radio"> <i>其他</i>
									</div>
								</div>
								<div class="controls">
									<p>收货地址：</p>
									...
									<input type="text" class="input03 w320"  name="receipt_address" id="receipt_address">
								</div>
								<!-- <div class="controls">
									<p>采购开始时间：</p>
									<input type="text"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
										class="input03 w155"  name="start_time" id="start_time">
								</div> -->
								<div class="controls">
									<p>采购截止时间：</p>
									<input type="text" readonly="readonly"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
										class="input03 w155"  name="end_time" id="end_time">
								</div>
							</div>
							<div class="member-column">
								...
								<div class="controls">
									<p>联系人：</p>
									<input type="text" class="input03 w320"  name="contacts" id="contacts">
								</div>
								<div class="controls">
									<p>公司名称：</p>
									<input type="text" class="input03 w320" name="company_name" id="company_name">
								</div>
								<div class="controls">
									<p>手机号：</p>
									<input type="text" class="input03 w320" name="contacts_phone" id="contacts_phone">
								</div>
