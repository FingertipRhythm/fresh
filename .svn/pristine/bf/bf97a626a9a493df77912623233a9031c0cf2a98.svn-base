...
<head lang="en">
    <meta charset="UTF-8">
    <title>ä¾åºåç®¡ç-éè´­ç®¡ç-æçè®¢å</title>
...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">æçè®¢å</a>
        </div>
         <!-- ä¼åå·¦ä¾§ -->
         ...
         <div class="member-right">
                 ...
                 <dl>
                    ...
                    <dd>
                        ...
                        <div class="search-btn">
                            <input type="submit" class="btn03" value="æ£ç´¢">
                        </div>
                    </dd>
                </dl>
            </div>
            ...
            <div class="order-received">
               <table>
                   <thead>
                       <tr>
                           <th width="110px;"><input type="checkbox" class="check-all"><label for="">å¨é</label></th>
                           <th width="120px;">ååä¿¡æ¯</th>
                           <th width="110px;">è§æ ¼</th>
                           <th width="165px;">åä»·</th>
                           <th width="130px">æ°é(åå)</th>
                           <th width="120px;">æ»éé¢</th>
                           <th width="110px;">è®¢åç¶æ</th>
                           <th>æä½</th>
                       </tr>
                   </thead>
                   <tbody>
                       ...
                       <tr class="order-tit">
                           <td colspan="8">
                               <div class="buyers">éè´­åï¼æ·±å³XXXXå¬å¸</div>
                               <div class="num">è®¢åç¼å·ï¼201505070001</div>
                               <div class="time">è®¢åæ¶é´ï¼2014-07-10 11:12:25</div>
                               <div class="tel">èç³»çµè¯ï¼18911111111</div>
                               <div class="address">å°åï¼ç¦å»ºçç¦å·å¸XXXXXXå·¥ä¸å­</div>
                           </td>
                       </tr>
                       <tr class="order-con">
                           ...
                           <td colspan="4" class="pro-infors">
                                <table>
                                    <tr>
                                        <td width="120px;"><a href="javascript:;">çåè</a></td>
                                        <td width="110px;">160g</td>
                                        <td width="165px;"><span>ï¿¥500.00</span>RBM/kg</td>
                                        <td width="128px">1000</td>
                                    </tr>
                                    <tr>
                                        <td>çåè</td>
                                        <td>160g</td>
                                        <td><span>ï¿¥500.00</span>RBM/kg</td>
                                        <td>1000</td>
                                    </tr>
                                </table>
                           </td>
                           <td>
                            <div class="pro-totalPrice">ï¿¥100000.00</div>
                           </td>
                           <td>å·²çæ</td>
                           <td><a href="javascript:;" class="btn04">ä¸ä¼ ä»æ¬¾å­è¯</a></td>
                       </tr>
                   </tbody>
                   <tbody>
                        <!-- æ§å¶é´è· -->
                    ...
                    <tbody>
                       ...
                       <tr class="order-con">
                           ...
                           <td>å·²ä»æ¬¾</td>
                           <td>
                               <a href="javascript:;" class="btn04 pop-pay" data-src="images/upload-img02.png">æ¥çä»æ¬¾å­è¯</a>
                               <a href="javascript:;" class="btn04">æ¥çå¼ç¥¨ä¿¡æ¯</a>
                               <a href="javascript:;" class="btn04">ç»äº¤æåè¯å</a>
                           </td>
                       </tr>
                   </tbody>
                    <tbody>
                       ...
                       <tr class="order-con">
                           ...
                           <td>
                               <a href="javascript:;" class="btn04 pop-pay" data-src="images/upload-img02.png">æ¥çä»æ¬¾å­è¯</a>
                               <a href="javascript:;" class="btn04">æ¥çå¼ç¥¨ä¿¡æ¯</a>
                               <a href="javascript:;" class="btn04">å·²è¯å</a>
                           </td>
                       </tr>
                   </tbody>
               </table>
