...
<head lang="en">
    <meta charset="UTF-8">
    <title>ä¾åºåç®¡ç-éè´­ç®¡ç-æçè®¢å-ç»äº¤æåè¯å</title>
...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">ç»äº¤æåè¯å</a>
        </div>
         <!-- ä¼åå·¦ä¾§ -->
         ...
         <div class="member-right">
            ...
            <div class="order-received">
               <div class="member-subtit">è®¢åè¯¦æ</div>
               <table>
                   <tr class="order-tit">
                       <td colspan="7">
            ...
            <!-- äº¤æå -->
            <div class="member-detailtit">äº¤æå</div>
            <div class="detail-con">
               <dl>
                    <dd><p>åååº--å¼ ä¸   18688738756</p></dd>
               </dl>
            </div>
            <!-- æå¡è¯ä»· -->
            <div class="member-detailtit">æå¡è¯ä»·</div>
            <div class="controls">
            ...
            <input type="submit" value="æäº¤" class="btn01">
         </div>
    </div>
</div>
<!--ç½ç«åºé¨-->
