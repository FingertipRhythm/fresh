...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">我的资源单</a>
        </div>
         <!-- 会员左侧 -->
                        ...
                        <table>
                            <thead>
                                  <tr>
                                    ...
                                    <th style="width: 200px;">主营</th>
                                    <th style="width: 200px;">资源单说明</th>
                            ...
                            <c:if test="${Resource.state==1 }" >
                             <tr>
                                    <td>
                                       	 资源id：${Resource.resourcesid }
                                    </td>
                                    <td>
                                    <c:forEach items="${alldetails }" var="detaillist">
                                    <c:forEach items="${detaillist }" var="detail">
                                    <c:if test="${Resource.resourcesid==detail.resources.resourcesid }">
                                    <p><c:if test="${detail.freshProduct.classid==1 }">冷藏肉类</c:if>
                                    <c:if test="${detail.freshProduct.classid==2 }">冷冻海鲜</c:if>
                                    <c:if test="${detail.freshProduct.classid==3 }">冷藏果蔬</c:if>
                                    </p>
                                    </c:if>
                                    </c:forEach>
                                    </c:forEach>
                                ...
                                <c:forEach items="${detaillist }" var="detail">
                                    ...
                                    <td><a href="javascript:;" resourceid class="btn04">快速预览</a><a href="javascript:;" class="btn04">下载</a><a href="javascript:;" class="btn04">删除</a></td>
                                </tr>
                              </c:if>
                            </c:forEach>
                                ...
                                <tr>
                                    ...
                                    <td>58</td>
                                    <td><a href="javascript:;" class="btn04">快速预览</a><a href="javascript:;" class="btn04">下载</a><a href="javascript:;" class="btn04">删除</a></td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- page -->
                       ...
                       <!-- 供应商管理 待审核 -->
                        <table>
                            ...
                            <c:forEach items="${Resourceslist }" var="Resource">
                             ...
                             <tr>
                                    <td>
                                        ${Resources.state}${Resource.resourcesid }
                                    </td>
                                    <td>
                                    <c:forEach items="${alldetails }" var="detaillist">
                                    <c:forEach items="${detaillist }" var="detail">
                                 ...
                                 <tr>
                                    ...
                                    <td>015-05-05 14：15</td>
                                    <td>58</td>
                                    <td><a href="javascript:;" class="btn04">快速预览</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        2015050006
                            ...
                            <c:if test="${Resource.state==0 }">
                             <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>015-05-05 14：15</td>
                                    <td>58</td>
                                    <td><a href="javascript:;" class="btn04">快速预览</a><a href="javascript:;" class="btn04">修改</a><a href="javascript:;" class="btn04">删除</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        2015050006
