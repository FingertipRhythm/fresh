...
<div class="content-main">
    <div class="container">
        ...
        <div class="bread-crumbs">
            ...
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;">我参与的竞标</a>
            <span><i class="fa fa-angle-double-right"></i></span>
            <a href="javascript:;" class="selected">我参与的竞标详情页</a>
        </div>
         <!-- 会员左侧 -->
            ...
            <div class="member-main">
                ...
                <div class="member-column">
                    ...
                    <div class="detail-con">
                        ...
                        <a href="member-供应商管理-我参与的竞价.html" class="back btn01 w100">返回</a>
                    </div>
                </div>
            </div>
         </div>
